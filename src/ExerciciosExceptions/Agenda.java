...
class Agenda {
	...
	static  void adicionarContato() {
		...
		do {
			System.out.println("Deseja adicionar o " + (contador+1) + "� contato ? (1) para sim, (2) para n�o: ");
	...
	static void consultaContatos() {
		System.out.println("----------------------------------");
		System.out.println("    Ol� seja bem vindo a agenda   ");
		System.out.println("  Aqui est� a lista de contatos:  ");
		System.out.println();
