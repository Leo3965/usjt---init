	...
	public static void main(String[] args) {
		...
		while(!ganhou) {
			...
			if((jogoDaVelha[0][0] == 'X' && jogoDaVelha[0][1] == 'X' && jogoDaVelha[0][2] == 'X') || //linha 1
					...
					(jogoDaVelha[0][2] == 'X' && jogoDaVelha[1][1] == 'X' && jogoDaVelha[2][0] == 'X')//diagonal secundária
					) {
				ganhou = true;
				System.out.println("Parabéns, " + primeiroJ + " ganhou!");
					...
					(jogoDaVelha[0][2] == 'O' && jogoDaVelha[1][1] == 'O' && jogoDaVelha[2][0] == 'O')//diagonal secundária
					) {
				ganhou = true;
				System.out.println("Parabéns, " + segundoJ + " ganhou!");
			}else if(jogada > 9) {
				ganhou = true;
